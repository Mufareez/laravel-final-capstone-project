                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" name="product_name" value="{{ old('product_name',$product->product_name) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" name="cost_price" value="{{ old('cost_price',$product->cost_price) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" name="selling_price" value="{{ old('selling_price',$product->selling_price) }}"
                                    ...
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select" name="category_id">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" {{$product->category_id==$category->id ? 'selected' : ''}}>{{ $category->category_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
